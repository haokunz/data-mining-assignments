...
plot(yhat_test_CART, green_testing$revenue, main= "Comparison between CART Predicted and Real Revenue", xlab = "Predicted Rent: CART", ylab = "Revenue")
...
# RMSE_Bagging
plot(yhat_test_Bagging, green_testing$revenue, main="Comparison between Bagging Predicted and Real Revenue", xlab = "Predicted  Rent: Bagging", ylab = "Revenue")
...
# RMSE_gbm 
plot(yhat_test_gbm, green_testing$revenue, main="Comparison between Boosted Trees Predicted and Real Revenue", xlab = "Predicted  Rent: Boost", ylab = "Revenue")
