...
plot(dflights$DepTime, dflights$DepDelay, main = "Departure time vs. Departure Delay",
...
boxplot(DepDelay ~ time_bin, data = dflights, main = "Departure Time on Hourly Base",
        xlab = "departure time", ylab = "departure delay")
