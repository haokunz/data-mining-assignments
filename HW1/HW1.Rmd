...
author: "Haokun Zhang, Jyun-Yu Cheng and Lu Zhang"
date: '2023-01-25'
output: 
...
air_delay <- ggplot(AVG_Delay, aes(x=AirTime, y=DepDelay))+
  geom_line()+
  ggtitle("Graph1: Average Depature Delay based on Air Time")+
...
average_departure_delay_time_over_2008 <- ggplot(data = delay, aes(x = departureday, y = mean_dep_delay)) +
  geom_line()+
  labs(title = "Graph2: Average Departure Delay Time Over 2008 ")+
...
delay_day <- ggplot(delayoneday) +
  ...
  labs(title = "Graph3: Average Departure Delay Time Over One Day(Measured by Hours) ")+
