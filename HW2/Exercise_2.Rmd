...
```
##The coef for having poor and terrible credit history is -1.11 and -1.88. Having a poor or terrible credit history multiplies odds of default by 0.33 and 0.15. If the purpose of the model is to screen prospective borrowers to classify them into "high" versus "low" probability of default, this data set is not appropriate for building a predictive model, because of class imbalance, the ratio of number of non-default and default is more than 2:1, by blindly prediciting more than half of data points as non-default, this model will not predict default well
